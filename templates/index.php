<main>
    <section class="feedback-form">
        ...
        if (isset($_SESSION['feedback_success'])) {
            echo '<div class="alert alert-success" role="alert">' . $_SESSION['feedback_success'] . '</div>';
            echo '<a href="index.php" class="btn btn-primary mt-3">Home</a>';
        ...
        ?>
            ...
            <?php endif; ?>
            <form id="feedbackForm" action="index.php" method="post" class="needs-validation" novalidate>
                <div class="mb-4">
